#!/usr/bin/env python3
"""Deep-page builder for the Gravity & Light (general relativity) lab.
...
<title>{title_tab} · Gravity &amp; Light</title>
...
<nav><a href="../index.html">Course</a><a href="../concepts.html">Concepts</a><a class="active" href="../deep-track.html">Deep Track</a><a href="{id}.html">This concept</a></nav></header>
<main>
...
"""
FOOT = """<footer style="color:#5a5a5a;font-size:13px;border-top:1px solid var(--line,#dcdcdc);padding:22px 0 60px;margin-top:24px">Gravity &amp; Light · {name} deep dive · every quantity here is computed. Experiments in scripts/experiments/gr_run.py.</footer>
</main></body></html>
"""
def esc(s: str) -> str:
